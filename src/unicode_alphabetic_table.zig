//! Generated by tools/gen_unicode_alphabetic.py from Unicode 16.0.0
//! DerivedCoreProperties.txt (property: Alphabetic). Do not edit by hand.
//!
//! Sorted, non-overlapping inclusive [lo, hi] codepoint ranges of the
//! Unicode Alphabetic property; binary-search for `char::is_alphabetic` parity.

pub const alphabetic_ranges = [_][2]u21{
